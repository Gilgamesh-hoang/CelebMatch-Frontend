            ...
            <div className="grid col-span-4 space-y-4 ml-4 h-full place-content-center">
                {
                    result ?
                        (
                            result.length ? (
                                <div className="grid">
                                    <div className="justify-self-end text-lg">Tìm
                                        thấy <strong>{result.length}</strong> kết quả phù hợp
                                    </div>
                                    <Tabs
                                        tabPosition="left"
                                                                ...
                                                                <div className="space-y-4 text-gray-700">
                                                                    {item.birth_date && (
                                                                        <div className="flex items-center">
                                                                            ...
                                                                            <span
                                                                                className="font-medium">Ngày sinh:</span>
                                                                            <span
                                                                                className="ml-2">{new Date(item.birth_date).toLocaleDateString('vi-VN')}</span>
                                                                        </div>
                                                                    )}
                                                                    ...
                                                                    {item.songs && (
                                                                        <div>
                                                                            <div className="flex items-center mb-1">
                                                                                ...
                                                                                <h4 className="font-medium">Các bài hát
                                                                                    nổi bật</h4>
                                                                            </div>
                        ...
                        isSearching ? <Spin tip="Đang tìm kiếm" size="large">
                            ...
                            !result && <div className="text-center place-content-center text-lg">
